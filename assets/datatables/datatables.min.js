 ...
 *   https://datatables.net/download/#se/jq-3.3.1/dt-1.10.21
 *
 * Included libraries:
...
(function(a) {
    ...
    a(c).on("init.dt", function(b, c) {
        "dt" === b.namespace && (b = new a.fn.dataTable.Api(c),
        a.fn.dropdown && a("div.dataTables_length select", b.table().container()).dropdown(),
        a("div.dataTables_filter.ui.input", b.table().container()).removeClass("input").addClass("form"),
        a("div.dataTables_filter input", b.table().container()).wrap('<span class="ui input" />'))
    });
    return d
});